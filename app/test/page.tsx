    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {!result && <AlertCircle className="h-5 w-5 text-gray-500" />}
          {title}
        </CardTitle>
      </CardHeader>
      <CardContent>
    ...
    <div className="container mx-auto p-4 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>各APIエンドポイントの動作確認</CardDescription>
        </CardHeader>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <ResultCard title="ヘルスチェック" result={healthResult} loading={loading.health} />
        <ResultCard title="本API" result={booksResult} loading={loading.books} />
      </div>
    </div>
  )
}
